...
export const toDate = date => // The 'proper' month is stored in a DateObj but Date expects month index
...
export const normalizeDate = date => {
  ...
  const {
    ...
    month,
    day
  } = date; // 19 should evaluate to 2019

  const fullYear = year < 100 ? 2000 + year : year; // Missing date pieces are filled in with their current date values
