...
var _toFormattedParts = require("./toFormattedParts");

var createLocalizationProvider = function createLocalizationProvider(locale, formatterOptions) {
  ...
  var parseDate = function parseDate(date) {
    return (0, _dateParser.createDateParser)(normalizedLocale)(date);
  };
