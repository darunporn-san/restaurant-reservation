  ...
  return _temp = _class = /*#__PURE__*/function (_Component) {
    ...
    function AtlaskitSelect(props) {
      ...
      (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "cacheComponents", function (components, enableAnimation) {
        _this.components = enableAnimation ? (0, _animated.default)(_objectSpread(_objectSpread({}, defaultComponents), components)) : _objectSpread(_objectSpread({}, defaultComponents), components);
      });
