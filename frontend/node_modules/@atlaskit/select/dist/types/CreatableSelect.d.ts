...
declare const _default: {
    new <Option = import("./types").OptionType, IsMulti extends boolean = false>(props: import("./types").SelectProps<Option, IsMulti>): {
        ...
        cacheComponents: (components: Partial<import("react-select/src/components").SelectComponents<Option, IsMulti, import("react-select").GroupTypeBase<Option>>>, enableAnimation: boolean) => void;
        focus(): void;
        blur(): void;
