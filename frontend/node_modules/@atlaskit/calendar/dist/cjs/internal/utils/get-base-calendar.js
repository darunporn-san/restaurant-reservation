...
function getBaseCalendar(year, month) {
  ...
  var firstDate = -((_constants.daysPerWeek - weekStartDay + firstDay) % _constants.daysPerWeek);
  var lastDate = (0, _getDaysInMonth.default)(utcYear, utcMonth);
  var lastDay = (lastDate - firstDate) % _constants.daysPerWeek;
  var lastDateOfPreviousMonth = (0, _getDaysInMonth.default)(utcYear, utcMonth - 1);
